...
EOSDIR=/eos/user/d/dshekar/dataset_8s/dataset_8s_100x25x150_1100fb/
#EOSDIR=/eos/user/d/dshekar/dataset_9s/dataset_9s_100x25x150_1100fb/
#EOSDIR=/eos/user/d/dshekar/dataset_6s/dataset_6s_100x25x150/
#EOSDIR=/eos/user/d/dshekar/dataset_3sr/dataset_3sr_100x25x150/
#EOSDIR=/eos/user/d/dshekar/dataset_5s/dataset_5s_100x25x150/
#EOSDIR=/eos/user/d/dshekar/dataset_4s/dataset_4s_100x25x150/
#EOSDIR=/eos/user/d/dshekar/dataset_3s/dataset_3s_100x25x150/
#EOSDIR=/eos/user/d/dshekar/dataset14_50x12P5
#EOSDIR=/eos/user/d/dshekar/dataset14_50x20
#EOSDIR=/eos/user/d/dshekar/dataset14_50x15
#EOSDIR=/eos/user/d/dshekar/dataset14_50x10
